...
import io.javabrains.tinderaibackend.Utils;
...
public class ProfileCreationService {
    ...
    public void createProfiles(int numberOfProfiles) {
        ...
        List<String> myersBriggsPersonalityTypes = Utils.generateMyersBriggsTypes();
    ...
    private Profile generateProfileImage(Profile profile) {
        ...
        String randomSelfieType = getRandomElement(Utils.selfieTypes());
